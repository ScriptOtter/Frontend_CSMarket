...
export const SNIPER_RIFLE_FILTER = {
  title: "Снайперская винтовка",
  guns: ["Все снайперские винтовки", "AWP", "G3SG1", "SCAR-20", "SSG 08 "],
};

export const SMG_FILTER = {
  title: "Пистолет-пулемет",
  guns: [
    "Все пистолет-пулеметы",
    "MAC-10",
    "MP5-SD",
    "MP7",
    "MP9",
...
export const MACHINEGUN_FILTER = {
  title: "Пулемет",
  guns: ["M249", "Negev"],
};

export const SHOTGUN_FILTER = {
  title: "Дробовик",
  guns: ["Все дробовики", "MAG-7", "Nova", "Sawed-Off", "XM1014 "],
};

export const KNIFE_FILTER = {
  title: "Нож",
  guns: [
    "Все ножи",
    "Bayonet",
